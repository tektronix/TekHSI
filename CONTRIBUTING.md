...
Ready to contribute? Here's how to set up `TekHSI` for local development.
...
2. Fork `TekHSI` into a new repository.
...
4. Check to see if there are any [open issues](https://github.com/tektronix/TekHSI/issues) or [pull requests](https://github.com/tektronix/TekHSI/pulls) that are related to the change you wish to make.

5. Create or update an [issue](https://github.com/tektronix/TekHSI/issues) to track the status of your change.
...
Please note that the `TekHSI` project is released with a
